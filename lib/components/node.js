...
var TreeNode = (function (_React$Component) {
    ...
    _createClass(TreeNode, [{
        ...
        value: function onElementClick() {
            var showing = !this.props.node.showing;
            var toggled = !this.props.node.toggled;
            var onShowInfo = this.props.onShowInfo;
            if (onShowInfo) {
                onShowInfo(this.props.node, showing, toggled);
            }
        }
    }, {
        key: 'onExpanderClick',
        value: function onExpanderClick() {
            var toggled = !this.props.node.toggled;
...
TreeNode.propTypes = {
    ...
    onShowInfo: _react2['default'].PropTypes.func
};
